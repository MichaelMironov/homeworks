...
import static utils.JsonUtil.getFieldFromJson;
import static api.ContextHolder.replaceVarsIfPresent;
...
public class ApiSteps {
    ...
    public void extractVariables(Map<String, String> vars) {
        String responseBody = apiRequest.getResponse().body().prettyPrint();
